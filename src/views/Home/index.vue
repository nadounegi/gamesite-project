...
export default {
    ...
    computed:{
        ...
        xboxGames(){
            return this.$store.getters['home/goodsList'].filter(game =>
            game.attributes_summary.includes('Xbox') || game.attributes_summary.includes('Xbox 360')|| game.attributes_summary.includes('Xbox One') || game.attributes_summary.includes('Xbox Series S') || game.attributes_summary.includes('Xbox Series X'))
        },
        SwitchGames(){
            return this.$store.getters['home/goodsList'].filter(game =>
